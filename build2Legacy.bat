...
:: 主程序开始
call :log "========================================="
call :log "      MaidsoulKitchen Legacy构建脚本      "
call :log "========================================="
...
:: 阶段2: 清理Build旧版本JAR文件
call :log "🚩 阶段2: 清理Build旧版本JAR文件"
call :clean_old_jars "!PROJECT_DIR!\build\libs\" "%MOD_ID%*.jar" "*.jar" || goto :error
...
set "SOURCE_JAR=!PROJECT_DIR!\build\libs\%MOD_ID%-%VERSION%-all.jar"
set "TARGET_DIR=!PROJECT_DIR!\Legacy\libs\%MINECRAFT_VERSION%\legacy"
call :copy_files "!SOURCE_JAR!" "!TARGET_DIR!" || goto :error

:: 阶段4: 清理旧版本JAR文件
call :log "🚩 阶段5: 清理旧版本JAR文件"
call :clean_old_jars "!PROJECT_DIR!\Legacy\libs\%MINECRAFT_VERSION%\legacy" "%MOD_ID%*.jar" "%MOD_ID%-%VERSION%-all.jar" || goto :error

:: 阶段5: 重载Legacy依赖
call :log "🚩 阶段5: 重载Legacy依赖"
