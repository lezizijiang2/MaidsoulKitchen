...
public final class MkEntities {
    ...
    public static DeferredHolder<MemoryModuleType<?>, MemoryModuleType<List<MaidRec>>> MAID_RECS = MEMORY_MODULE_TYPES.register("maid_recs", () -> new MemoryModuleType<>(Optional.of(MaidRec.CODEC.listOf())));
}
