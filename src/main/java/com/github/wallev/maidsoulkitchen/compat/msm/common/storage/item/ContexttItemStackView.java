...
public class ContexttItemStackView extends AbstractFilterableBlockStorage implements IStorageInteractContext {
    ...
    public void start(EntityMaid maid, ServerLevel level, Target target) {
        ...
        helper = new SimulateItemStackInteractHelper(maid, target.getPos(), target.getSide().orElse(null), level);
        helper.open();
    }
